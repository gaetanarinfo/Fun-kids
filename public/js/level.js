...
function painOrPleasureP1() {
    ...
    jQuery.each(painAndPleasureArrayName, function (key) {
        ...
        bambou = painAndPleasureArrayName[key].bambou;
...
function Bambou(bambou) {

    var url = "/ajax/ajax-bambouOpen.php";
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (res.coinsChest === true) {
                ...
                $('.bambou').html(res.bambou);

            }

            if (res.bambouChest === false) {
...
function Rubis(rubis) {

    var url = "/ajax/ajax-rubisOpen.php";
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (res.coinsChest === true) {
                ...
                $('.rubis').html(res.rubis);

            }

            if (res.rubisChest === false) {
...
$(document).on('click', '.card_game .cards', function (e) {

    e.preventDefault();

    Jouer(this);

    $(this).addClass('rotate_cards');
